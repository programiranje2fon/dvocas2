...
public class PokreniTestove {
	...
	public static void main(String[] args) {
		runTestsForClass(zadatak1.AgregatnaStanjaTest.class);
		runTestsForClass(zadatak1.KonvertorTemperatureTest.class);
		runTestsForClass(zadatak2.BMIKategorijaTest.class);
		runTestsForClass(zadatak2.BMIKalkulatorTest.class);
	}
